...
class UserGroupController extends AdminController 
{
    ...
    public function add()
    {
        ...
        if (!$try)
        {
            ...
            $this->app->redirect(
                $this->router->url('admin/userGroupAdd'), $msg
            );
        }
        ...
        {
            $this->app->redirect(
                $this->router->url('admin/userGroups'), 'Save Successfully'
            );
        }
    }
    ...
    public function update()
    {
        ...
        if( is_array($sth) )
        {
            ...
            $this->app->redirect( $this->router->url('admin/userGroups'), $count.' changed record(s)');
        ...
        {   
            ...
            if (!$try)
            {
                $msg = $this->session->get('validate', '');
                $this->app->redirect(
                    $this->router->url('admin/userGroupUpdate/'.$sth), $msg
                );
            }
            ...
            {
                $this->app->redirect(
                    $this->router->url('admin/userGroups'), $msg
                );
            }
            else
            {
        ...
        $this->app->redirect(
            $this->router->url('admin/userGroups'), 'Error: Invalid request'
        );
    }
    ...
    public function delete()
    {
        ...
        $this->app->redirect( $this->router->url('admin/userGroups'), $count.' deleted record(s)');
    }
    ...
    public function validateID()
    {
        ...
        if(empty($id) && !$id)
        {
            ...
            $this->app->redirect(
                $this->router->url('admin/userGroups'), 'Invalid user group'
            );
        }
