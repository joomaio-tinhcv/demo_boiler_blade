...
class UserController extends AdminController
{
    ...
    public function login()
    {
        ...
        if ( $result )
        {
            ...
            {
                $this->app->redirect(
                    $this->router->url('admin/users'), 'Hello!!!'
                );
            }
        }
        else
    ...
    public function add()
    {
        ...
        if (!$try)
        {
            ...
            $this->app->redirect(
                $this->router->url('admin/userAdd'), $msg
            );
        }
        ...
        if($_FILES['avatar']['name']) {
            ...
            {
                $this->app->redirect(
                    $this->router->url('admin/userAdd'), 'Upload avatar fail'
                );
            }
        ...
        {
            $this->app->redirect(
                $this->router->url('admin/userAdd'), 'Error: Confirm Password Failed'
            );
        }
        ...
        if(is_numeric($ids) && $ids)
        {
            ...
            if($password == $repassword) 
            {
                if($_FILES['avatar']['name']) {
                    ...
                    {
                        $this->app->redirect(
                            $this->router->url('admin/userUpdate'. $ids), 'Upload avatar fail'
                        );
                    }
            ...
            {
                $this->app->redirect(
                    $this->router->url('admin/userUpdate/'.$ids), 'Error: Confirm Password Failed'
                );
            }
